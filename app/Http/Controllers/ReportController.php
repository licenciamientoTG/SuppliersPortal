...
class ReportController extends Controller
{
    ...
    public function index(Request $request) { return view('reports.index', ['reports' => ReportingService::REPORTS, 'monthlyStatus' => $this->reports->currentMonthStatusSummary($request->query('month'))]); }
