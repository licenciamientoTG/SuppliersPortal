...
class DashboardService
{
    ...
    private function buildStaffBoard(User $user): array
    {
        ...
        $activeStatuses = [
            ...
            RequisitionStatus::IN_APPROVAL->value,
        ];
        ...
        return [
            ...
            'kpis' => [
                ...
                $this->kpi('staff-quoted', 'Cotizadas / aprobación', (clone $staffRequisitions)->whereIn('status', [RequisitionStatus::QUOTED->value, RequisitionStatus::IN_APPROVAL->value])->count(), 'ti-receipt-2', 'primary', 'Cotizadas o con adjudicación en autorización.'),
    ...
    private function buildGeneralDirectorBoard(User $user): array
    {
        return [
            ...
            'kpis' => [
                ...
                $this->kpi('director-active-volume', 'Compras activas', Requisition::query()->whereIn('status', [RequisitionStatus::PENDING->value, RequisitionStatus::IN_QUOTATION->value, RequisitionStatus::QUOTED->value, RequisitionStatus::IN_APPROVAL->value])->count(), 'ti-briefcase', 'info', 'Volumen activo de requisiciones y cotizacion.'),
            ],
            'sections' => [
                [
