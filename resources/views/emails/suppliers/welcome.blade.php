                    ...
                    <tr>
                        <td style="padding:32px 32px 8px;">
                            <h1 style="font-size:20px;color:#0d2b5e;margin:0 0 16px;font-weight:700;">
                                ¡Le damos la bienvenida{{ $name ? ', '.$name : '' }}!
                            </h1>
                                ...
                                <tr>
                                    <td style="background-color:#f6f8fb;border:1px solid #e3e9f2;border-left:4px solid #A9CA48;border-radius:8px;padding:20px 22px;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="font-size:13px;color:#888888;padding:0 0 8px;width:110px;">Usuario</td>
                                                <td style="font-size:13px;color:#222222;padding:0 0 8px;font-weight:600;word-break:break-all;">{{ $email }}</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:13px;color:#888888;padding:0;">Contraseña</td>
                                                <td style="font-size:13px;color:#222222;padding:0;font-weight:600;font-family:'Courier New',Courier,monospace;">{{ $password }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            {{-- Aviso de seguridad --}}
                            <p style="font-size:12px;color:#9a6b00;background-color:#fff7e6;border:1px solid #ffe2a8;border-radius:6px;padding:10px 14px;margin:14px 0 28px;line-height:1.6;">
                            ...
                            {{-- Soporte --}}
                            <p style="font-size:12px;color:#999999;margin:18px 0 8px;text-align:center;line-height:1.6;">
