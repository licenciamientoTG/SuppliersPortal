        ...
        <div class="d-flex align-items-center gap-2">
            ...
            @php
                $notificationStyles = [
                    ...
                    'buyer_requisition_in_quotation' => ['icon' => 'ti ti-shopping-cart-search', 'color' => 'primary', 'title' => 'Lista para cotizar'],
                    'buyer_rfq_sent' => ['icon' => 'ti ti-send', 'color' => 'info', 'title' => 'RFQ enviada'],
                    'buyer_quotation_pending_approval' => ['icon' => 'ti ti-scale', 'color' => 'warning', 'title' => 'Adjudicación en aprobación'],
                    'buyer_rfq_cancelled' => ['icon' => 'ti ti-xbox-x', 'color' => 'danger', 'title' => 'RFQ cancelada'],
                    'buyer_requisition_cancelled' => ['icon' => 'ti ti-ban', 'color' => 'danger', 'title' => 'Requisición cancelada'],
