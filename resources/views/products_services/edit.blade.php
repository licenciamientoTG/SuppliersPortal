...
@section('page.title', 'Editar Producto/Servicio')
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select @error('product_type') is-invalid @enderror" 
                                        ...
                                        name="product_type" 
                                        required>
                                    <option value="PRODUCTO" {{ old('product_type', $productService->product_type) == 'PRODUCTO' ? 'selected' : '' }}>
                                        Producto Físico
                                    </option>
                                    <option value="SERVICIO" {{ old('product_type', $productService->product_type) == 'SERVICIO' ? 'selected' : '' }}>
                                        Servicio
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                                ...
                                id="short_name" 
                                name="short_name" 
                                value="{{ old('short_name') ?? $productService->short_name }}" 
                                maxlength="100"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" 
                                    ...
                                    id="brand" 
                                    name="brand" 
                                    value="{{ old('brand') ?? $productService->brand }}" 
                                    maxlength="100"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" 
                                    ...
                                    id="model" 
                                    name="model" 
                                    value="{{ old('model', $productService->model) }}"
                                    maxlength="100"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('unit_of_measure') is-invalid @enderror" 
                                ...
                                @foreach ($unitsOfMeasure as $value => $label)
                                    <option value="{{ $value }}" {{ old('unit_of_measure', $productService->unit_of_measure) == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control font-monospace @error('specifications') is-invalid @enderror" 
                                    ...
                                    name="specifications" 
                                    rows="4"
                                    placeholder='{"procesador": "Intel Core i7", "ram": "16GB", "almacenamiento": "512GB SSD"}'>{{ old('specifications', $productService->specifications ? json_encode($productService->specifications, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : '') }}</textarea>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select @error('default_vendor_id') is-invalid @enderror" 
                                    ...
                                    @foreach ($suppliers as $supplier)
                                        <option value="{{ $supplier->id }}" {{ old('default_vendor_id', $productService->default_vendor_id) == $supplier->id ? 'selected' : '' }}>
                                            {{ $supplier->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" 
                                        ...
                                        id="lead_time_days" 
                                        name="lead_time_days" 
                                        value="{{ old('lead_time_days', $productService->lead_time_days) }}" 
                                        min="1"
                                        max="365"
                                        placeholder="Ej: 15">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                    ...
                                    value="{{ old('minimum_quantity', $productService->minimum_quantity) }}" 
                                    step="0.001"
                                    min="0.001"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                    ...
                                    value="{{ old('maximum_quantity', $productService->maximum_quantity) }}" 
                                    step="0.001"
                                    min="0.001"
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('observations') is-invalid @enderror" 
                                    ...
                                    rows="3"
                                    maxlength="2000"
                                    placeholder="Información visible para requisitores...">{{ old('observations', $productService->observations) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('internal_notes') is-invalid @enderror" 
                                    ...
                                    rows="3"
                                    maxlength="2000"
                                    placeholder="Notas privadas solo visibles para el área de Compras...">{{ old('internal_notes', $productService->internal_notes) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="number" 
                                        ...
                                        value="{{ old('estimated_price', $productService->estimated_price) }}" 
                                        step="0.01"
                                        min="0" 
                                        required 
                                        placeholder="0.00">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" 
                                    ...
                                    id="account_major" 
                                    name="account_major" 
                                    value="{{ old('account_major', $productService->account_major) }}"
                                    min="1" 
                                    max="9999"
                                    required
                                    placeholder="Ej: 5101">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" 
                                    ...
                                    id="account_sub" 
                                    name="account_sub" 
                                    value="{{ old('account_sub', $productService->account_sub) }}" 
                                    min="1" 
                                    max="9999"
                                    required
                                    placeholder="Ej: 1">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" 
                                    ...
                                    id="account_subsub" 
                                    name="account_subsub" 
                                    value="{{ old('account_subsub', $productService->account_subsub) }}"
                                    min="1" 
                                    max="9999"
                                    required
                                    placeholder="Ej: 1">
                        ...
                        <div class="form-text small">
                            <i class="ti ti-help me-1"></i>Dejar vacío si desconoce
                        </div>
                    </div>
                </div>
            </div>
